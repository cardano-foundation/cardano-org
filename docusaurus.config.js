        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { to: '/governance#delegate', label: 'Delegate your ada' },
              ...
              columns: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { to: '/governance#delegate', label: 'Delegate your ada', description: 'Lend your voting power to a DRep', icon: 'scroll-solid' },
                    ...
                    { to: '/constitution', label: 'Cardano Constitution', description: 'Read the governing document', icon: 'scroll-solid' },
                  ],
                },
              ],
            },
