  ...
  return (
    <div className={clsx("container", styles.sectionWrapper)}>
       ...
       <h1 className= {styles.title}>
          A Model To Marginalize None,<br />
          And Give Power To All.
      </h1>
      <p className= {styles.text}>
        Our current systems do not work for everyone. A better, more positive future is possible. If the world 
        is to serve the many, it must be agreed to by the many. Consensus must drive progress and where 
