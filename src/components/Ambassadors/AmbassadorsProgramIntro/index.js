    ...
    <section>
      ...
      <TitleWithText
        title={translate({
          ...
          message: "The Cardano Community Ambassador Program",
        })}
        description={[
          translate({
            id: "ambassadors.program.description1",
            message:
          ...
          translate({
            id: "ambassadors.program.description2",
            message:
          ...
          translate({
            id: "ambassadors.program.description3",
            message:
