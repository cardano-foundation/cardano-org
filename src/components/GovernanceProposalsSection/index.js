      ...
      <div className={styles.flexBox}>
        ...
        <div className={styles.rightTextWrap}>
          <h2>Cardano Improvement Proposal (CIP)</h2>
            <p>
            A formally structured proposal touching the Cardano Ecosystem. CIPs are publicly visible to the community for 
            discussion, and are located in the Cardano Foundation GitHub CIP repository.
            </p>
        </div>
      </div>
    </div> 
