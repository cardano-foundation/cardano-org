...
import {
  ...
  FaFlask, FaChartLine, FaHistory, FaBuilding, FaGraduationCap, FaCode, FaFileContract,
} from "react-icons/fa";
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { key: "smart-contracts", href: "/smart-contracts", icon: <FaFileContract />, title: translate({ id: "learn.item.smartContracts.title", message: "Smart contracts and DApps" }), text: translate({ id: "learn.item.smartContracts.text", message: "What a contract is, how Cardano runs it and how to use a DApp safely." }) },
        { key: "defi", href: "/defi", icon: <FaCoins />, title: translate({ id: "learn.item.defi.title", message: "DeFi on Cardano" }), text: translate({ id: "learn.item.defi.text", message: "Swap, lend, borrow and earn with open applications, and the risks to know." }) },
