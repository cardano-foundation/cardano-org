  ...
  return [
    {
      ...
      answer: [
        translate({
          ...
          message:
            "Cardano has no single official roadmap, because development is coordinated by several organizations. This page follows the network upgrades: the public plans of Intersect, Input Output, and the Cardano Foundation, with a link to the source on every entry. The original five-phase roadmap was published by Input Output at [roadmap.cardano.org]({originalRoadmap}), the research behind it is on the [research page](/research), and the long-term direction is now set through [Vision 2030]({vision}). After Dijkstra, Cardano documentation pencils in an era named Euler, with no scope yet.",
