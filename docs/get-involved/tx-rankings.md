...
Some apps on cardano.org are ranked based on their on-chain transaction activity over the last 30 days. This data-driven approach helps users discover the most actively used applications in the Cardano ecosystem.

## Current Implementation

Transaction-based rankings are currently displayed on:
- **Decentralized Exchanges (DEXs)** - on the [Where to get ada](/where-to-get-ada#exchanges) page

Apps with transaction data show:
- Total transaction count for the last 30 days
- Ranking position within their category (e.g., #1, #2, #3 among DEXs)
- Gold badges for top 3 positions
