...
- A homepage that is so generic it could belong to any project on any chain — no concrete demonstration of what the app actually does
...
Project teams who want to be re-added after a removal should reopen via the standard [Add your application](/docs/get-involved/add-app) submission flow — same review as any new submission. Past listing does not grant a fast-track.
