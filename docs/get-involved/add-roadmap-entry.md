...
The [network upgrades page](/roadmap) shows what runs on mainnet, what is being built, how an upgrade gets decided, and every upgrade so far. All of it comes from `src/data/roadmap.js`. This page explains the entries and the rules.
