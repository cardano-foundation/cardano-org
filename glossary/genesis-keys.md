...
`d` reached 0 on March 31, 2021, leaving block production fully in community hands. The Genesis Keys' last residual role was retired when the Vasil hard fork removed the `d` parameter entirely.
