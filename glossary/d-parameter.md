...
A protocol parameter from the Shelley era written `d` that determined how block production was split between the federated nodes run by the founding entities and the growing set of community stake pools.
