...
`d` started at 1.0 (fully federated, before Shelley), declined incrementally through 2020 as decentralization progressed, and reached 0 on March 31, 2021, leaving block production entirely in the hands of community SPOs. The parameter was removed from the protocol at the Vasil hard fork once the federation no longer played any role in producing blocks.
