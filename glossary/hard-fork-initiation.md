...
A governance action type that proposes scheduling a hard fork at a specific epoch. Like other Conway actions it goes through DRep, Constitutional Committee, and stake pool operator voting; once it passes, the protocol upgrades itself at the chosen epoch without any out-of-band coordination.
