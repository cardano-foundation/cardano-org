...
title: Plutus Core
slug: plutus-core
short: Cardano's on-chain smart-contract runtime. Higher-level languages (Plinth, Aiken, Marlowe) all compile down to Plutus Core for execution.
category: smart-contracts
related: [untyped-plutus-core-uplc, plinth, aiken, marlowe, smart-contract]
---

The runtime that actually executes smart contracts on Cardano. Plutus Core is an umbrella for two related languages: Untyped Plutus Core (UPLC), which is what runs on-chain, and Typed Plutus Core (TPLC), an intermediate form used by compilers. Higher-level languages like [Plinth](/glossary/plinth), [Aiken](/glossary/aiken), and [Marlowe](/glossary/marlowe) all compile down to Plutus Core.
