...
The floor was 340 ada from the Shelley launch until October 2023, when it was halved to 170 ada, the value still in force. A further cut to 75 ada, bundled with an increase of the Plutus memory limits, expired on September 1, 2026 with DRep and committee support but only 34.5 percent of stake pool stake in favor. The [governance action](https://explorer.cardano.org/governance-action/gov_action14dr5yg75pchr2sz42djtuflpvx5qnsek29qg7s7cft8lzrqt5vrqqtqntpk) has the full vote record.
