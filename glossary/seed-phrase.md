...
A sequence of 12 or 24 words generated when you first set up a wallet. It is the master key from which all of the wallet's private keys are derived, and the only thing you need to recover your funds if your device is lost, broken, or wiped.
