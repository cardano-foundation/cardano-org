...
A rollback happens when a node discovers that the chain it has been following has been overtaken by a longer or denser chain produced by a different fork. The conflicting tip blocks are reverted, and the node switches to the new chain.
