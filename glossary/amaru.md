...
title: Amaru
slug: amaru
short: A Rust implementation of the Cardano node, maintained by PRAGMA as an alternative to the canonical Haskell node.
category: network
...
The project is maintained by [PRAGMA](https://pragma.builders/) with contributors from multiple Cardano ecosystem teams, and is still maturing toward feature parity with the Haskell node.
